  ...
  return (
    <div className="bg-gray-800/80 md:bg-gray-800 border-t border-gray-700 p-3 md:p-4 flex flex-col gap-3">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center space-x-3 bg-gray-900 px-3 py-1.5 rounded-lg border border-gray-700 flex-grow md:flex-grow-0 justify-between md:justify-start">
