  ...
  return (
    <div className="min-h-screen w-full bg-gray-950 text-gray-100 font-sans flex flex-col">
      ...
      <div className="flex-1 px-6 py-12">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-xs text-gray-500 font-bold uppercase tracking-widest mb-6">Chapters</h2>
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">Free-play with any FRACTRAN program</div>
                </div>
              </div>
              <ChevronRight size={18} className="text-gray-600 group-hover:text-gray-400 transition-colors" />
            </button>
